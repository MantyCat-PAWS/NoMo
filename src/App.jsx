...
const styles = {
  ...
  header: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "18px 32px", borderBottom: `1px solid ${COLORS.hairline}`, background: "rgba(246,241,230,0.92)", backdropFilter: "blur(6px)", position: "sticky", top: 0, zIndex: 5 },
  logo: { fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: 24, letterSpacing: "0.005em", color: COLORS.ink },
  ...
  hero: { background: COLORS.paper, color: COLORS.ink, padding: "88px 28px 64px", textAlign: "center" },
  heroEyebrow: { fontFamily: "'Inter', sans-serif", fontSize: 12, letterSpacing: "0.18em", color: COLORS.lime, marginBottom: 18 },
  heroTitle: { fontFamily: "'Playfair Display', serif", fontWeight: 600, fontSize: 52, lineHeight: 1.12, margin: "0 0 20px", letterSpacing: "-0.01em", color: COLORS.ink },
  heroSub: { maxWidth: 480, margin: "0 auto 14px", fontSize: 17, lineHeight: 1.55, color: COLORS.muted },
  heroSubSmall: { maxWidth: 480, margin: "0 auto 28px", fontSize: 13.5, lineHeight: 1.5, color: COLORS.stone, opacity: 0.9 },
  heroCta: { display: "inline-block", background: COLORS.ink, color: COLORS.paper, fontFamily: "'Inter', sans-serif", fontWeight: 600, fontSize: 14.5, padding: "15px 30px", borderRadius: 999, textDecoration: "none", boxShadow: "0 1px 2px rgba(33,28,20,0.08), 0 10px 24px rgba(33,28,20,0.16)", cursor: "pointer", letterSpacing: "0.01em" },
  ...
  profileSectionTitle: { fontFamily: "'Playfair Display', serif", fontSize: 24, fontWeight: 600, margin: "0 0 12px", color: COLORS.ink },
  ...
  boardTitle: { fontFamily: "'Playfair Display', serif", fontSize: 30, fontWeight: 600, margin: 0, color: COLORS.ink },
  ...
  legalTitle: { fontFamily: "'Playfair Display', serif", fontSize: 36, fontWeight: 600, margin: "0 0 16px", color: COLORS.ink },
